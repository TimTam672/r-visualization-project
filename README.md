...
* **Data Visualization:** `ggplot2` (Static), `plotly` (Interactive render engine)
* **Reporting Architecture:** `R Markdown` (Knitr HTML5)

## 📌 Core Technical Highlights
* **Advanced Statistical Graphics:** Engineered a comprehensive suite of graphics including **Scatter, Density, Box, Jitter, and PCA (Principal Component Analysis) plots** to analyze variable loading scores.
